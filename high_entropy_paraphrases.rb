arr_strings = ["pphsv ojtou brvhsj cer ntfhlra udeh ccgtyzc zoyzmh jum lugbnk",
...
split_arr = []
arr_strings.each do |subarr|
   split_arr << subarr.split(" ")
end

def unique_words_in_array(arr)
  hash = {}
  arr.each do |word|
  ...
  if arr.length != hash.length
    return false
  end
  return true
end

def unique_words_in_array_of_arrays(arr_of_arrs)
  sum = 0
  arr_of_arrs.each do |subarr|
    sum += 1 if (unique_words_in_array(subarr) == true)
  end
  return sum
end
...
def unique_words_in_array_no_anagrams(arr)
  hash = {}
...
def unique_words_in_array_of_arrays_no_anagrams(arr_of_arrs)
  sum = 0
  arr_of_arrs.each do |subarr|
    sum += 1 if (unique_words_in_array_no_anagrams(subarr) == true)
  end
  return sum
end
 ...
 p split_arr.length
 p unique_words_in_array_of_arrays(split_arr)

 p unique_words_in_array_of_arrays_no_anagrams(split_arr)
